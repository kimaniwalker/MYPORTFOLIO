                ...
                <div className="row gx-5">
                    ...
                    <div id="introCol" className="col-lg-8 col-md-12 col-sm-12 bg-light">
                        ...
                        <div className="row py-4">
                            ...
                            <span className="pt-2">I love front and back end development. I primarily code all of my apps in React & NodeJs. I typically use express on the backend and MySQL to hold my data. To style my components , I use bootstrap and take advantage of it great flex and grid preperites. I hope that by visiting my portfolio you get the impression that I really am passionate about coding. Please leave a comment in the container below. We would love to hear from you. If you are interested in a estimate, you can also leave a comment here. I will follow up with 1-2 business days.</span>
                        </div>
                        <div className="row py-4">
